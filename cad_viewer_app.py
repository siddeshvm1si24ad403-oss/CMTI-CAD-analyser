...
def create_3d_viewer_html(glb_path):
    ...
    <body>
        <div id="info">
            ...
            <b style="color: #667eea;">🖱️ CONTROLS:</b> Left-Drag: Rotate | Scroll: Zoom | Right-Drag: Pan<br>
            <b style="color: #667eea;">⌨️ VIEW:</b> T-Top | F-Front | R-Right | I-Isometric | B-Bottom | L-Left
            </span>
        </div>
...
if st.session_state.model_data is None:
    ...
    with col_right:
        ...
        if geo_data:
            ...
            # Check if it's a single connected component
